...
export const TenantTable: React.FC<Props> = (props) => {
    ...
    useLayoutEffect(() => {
        const isIndeterminate = selectedPeople.length > 0 && selectedPeople.length < props.data.length
        setChecked(selectedPeople.length === props.data.length)
        setIndeterminate(isIndeterminate)
        checkbox.current!.indeterminate = isIndeterminate
    }, [selectedPeople])

    function toggleAll() {
        setSelectedPeople(checked || indeterminate ? [] : props.data)
