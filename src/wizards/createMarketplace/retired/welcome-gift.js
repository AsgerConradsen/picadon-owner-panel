...
const steps = [
    ...
    { name: 'Welcome gift', href: '#', status: 'current' },
                    ...
                    <main className="flex-1">
                        <div className="py-6 flex flex-col">
                            <div className="max-w-7xl px-4 py-8 sm:px-8 md:px-20">
                                <h1 className="text-2xl font-semibold text-gray-900">Welcome gift</h1>
                                <h2 className="text-l text-gray-500">A welcome gift is given as part of the invitation to a Picadon marketplace</h2>
                            </div>
                            <form onSubmit={props.handleSubmit(props.onSubmit)} className="max-w-xl px-4 sm:px-6 md:px-20" >
                                <div className='py-2'>
                                    ...
                                    <select
                                        ...
                                        defaultValue="No gift"
                                        {...register("test")}
                                    >
                                        <option>No gift</option>
                                        <option>20€</option>
                                        <option>30€</option>
                                        <option>50€</option>
                                        <option>100€</option>
